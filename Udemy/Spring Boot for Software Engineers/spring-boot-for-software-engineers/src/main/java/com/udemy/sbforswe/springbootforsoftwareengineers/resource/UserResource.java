...
public class UserResource {
    ...
    @RequestMapping(method= RequestMethod.GET, path ="/{userUUID}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(method = RequestMethod.DELETE, path = "/{userUUID}", produces = MediaType.APPLICATION_JSON_VALUE)
